...
CORE_KEEP=(
  ...
  dcdbas wmi wmi_bmof
  # RAPL / térmica core (int340x/processor_thermal retirados, sin uso real)
  intel_rapl_msr intel_rapl_common intel_rapl_uncore rapl
  x86_pkg_temp_thermal coretemp intel_tcc_cooling intel_pmc_core
  intel_lpss_pci intel_lpss idma64 acpi_pad
